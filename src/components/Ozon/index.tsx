...
import { wrapText, setWorkerSrc, resizeOzonPdfPages, drawTextOnPagesOzon, getOzonPDFText, fileRead, createPdfFile } from '../../utils';
import '../../App';
...
export const OzonFields = (): ReactElement => {
    ...
    const handleXLSXSelected = (e: React.ChangeEvent<HTMLInputElement>) => {
        const getSortedArr = fileRead(e)
        ozonSetProductList(getSortedArr as unknown as SetStateAction<ProductList>);
